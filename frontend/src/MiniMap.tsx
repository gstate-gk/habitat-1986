...
const ROOMS: { id: number; name: string; x: number; y: number; color: string }[] = [
  { id: 1, name: "Town Square", x: 120, y: 80, color: "#00ff88" },
  { id: 2, name: "Bank", x: 30, y: 80, color: "#ffcc00" },
  { id: 3, name: "Store", x: 210, y: 80, color: "#ff8844" },
  { id: 4, name: "Park", x: 120, y: 150, color: "#44cc44" },
  { id: 5, name: "Teleport", x: 210, y: 150, color: "#44ccff" },
  { id: 6, name: "Haunted", x: 30, y: 20, color: "#aa44ff" },
  { id: 7, name: "Lounge", x: 210, y: 20, color: "#ff44aa" },
];
