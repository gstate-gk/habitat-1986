...
const ROOMS: { id: number; name: string; x: number; y: number; color: string }[] = [
  { id: 1, name: "Town Square", x: 145, y: 190, color: "#00ff88" },
  { id: 2, name: "Bank", x: 40, y: 190, color: "#ffcc00" },
  { id: 3, name: "Store", x: 250, y: 190, color: "#ff8844" },
  { id: 4, name: "Park", x: 145, y: 330, color: "#44cc44" },
  { id: 5, name: "Teleport", x: 250, y: 330, color: "#44ccff" },
  { id: 6, name: "Haunted", x: 40, y: 55, color: "#aa44ff" },
  { id: 7, name: "Lounge", x: 250, y: 55, color: "#ff44aa" },
];
...
export default function MiniMap({ currentRegionId, onNavigate }: MiniMapProps) {
  return (
    <div style={{
      ...
      <svg width="100%" viewBox="0 0 290 385" style={{ display: "block" }}>
        {CONNECTIONS.map(([a, b]) => {
